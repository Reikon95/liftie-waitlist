      ...
      <section className="px-5 sm:px-8 py-20 sm:py-28 bg-[hsl(var(--screenshot-bg))]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 items-end">
            <Image src="https://nuuhkrrfvunxacxqpazn.supabase.co/storage/v1/object/public/screenshots/create%20program.png" width={260} height={564} alt="..." className="rounded-[2rem] shadow-xl" />
            ...
            >
              <Image src="https://nuuhkrrfvunxacxqpazn.supabase.co/storage/v1/object/public/screenshots/dash.png" width={260} height={564} alt="..." className="rounded-[2rem] shadow-xl" />
            </div>
            <div
            ...
            >
              ...
              <Image src="https://nuuhkrrfvunxacxqpazn.supabase.co/storage/v1/object/public/screenshots/workout.png" width={260} height={564} alt="..." className="rounded-[2rem] shadow-xl" />
            </div>
